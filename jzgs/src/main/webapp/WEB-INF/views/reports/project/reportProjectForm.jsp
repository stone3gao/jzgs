...
<body>
	...
	<form:form id="inputForm" modelAttribute="reportProject" action="${ctx}/project/reportProject/save" method="post" class="form-horizontal">
		...
		<c:if test="${reportProject != null && not empty reportProject.createBy.name}">
			<div class="control-group">
				<label class="control-label">创建人:</label>
				<div class="controls">
					<label class="lbl">${reportProject.createBy.name}</label>
				</div>
			</div>			
			<div class="control-group">
				<label class="control-label">创建时间:</label>
				<div class="controls">
					<label class="lbl"><fmt:formatDate value="${reportProject.createDate}" type="both" dateStyle="full"/></label>
				</div>
			</div>
			<c:if test="${not empty reportProject.updateBy.name}">
				<div class="control-group">
					<label class="control-label">更新人员:</label>
					<div class="controls">
						<label class="lbl"> ${reportProject.updateBy.name}</label>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">更新时间:</label>
					<div class="controls">
						<label class="lbl"><fmt:formatDate value="${reportProject.updateDate}" type="both" dateStyle="full"/></label>
					</div>
				</div>				
			</c:if>	
		</c:if>		
