...
public class LeaveService extends BaseService {
    ...
    public void save(Leave leave, Map<String, Object> variables) {
        ...
        variables.put("dept", "gaolei01");
        variables.put("hr", "gaolei02");

        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey(ActUtils.PD_LEAVE[0],
                ActUtils.PD_LEAVE[1] + ":" + businessKey, variables);
